...
func TestTypedAst_ToJSONSchema(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			data: `{"prim": "option","args": [{"prim": "pair","args": [{"prim": "signature","annots": ["%pour_auth"]},{"prim": "mumav","annots": ["%pour_amount"]}],"annots": ["%Pour"]}]}`,
			want: &JSONSchema{
				Type:  JSONSchemaTypeObject,
				Prim:  "option",
				Title: "@option_1",
...
func TestTypedAst_Docs(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			data: `[{"prim":"parameter","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"contract","args":[{"prim":"unit"}],"annots":["%dest"]},{"prim":"mumav","annots":["%transfer_amount"]}],"annots":["%Transfer"]},{"prim":"option","args":[{"prim":"pair","args":[{"prim":"contract","args":[{"prim":"unit"}],"annots":["%pour_dest"]},{"prim":"key","annots":["%pour_authorizer"]}]}],"annots":["%Set_pour"]}]},{"prim":"or","args":[{"prim":"pair","args":[{"prim":"list","args":[{"prim":"pair","args":[{"prim":"list","args":[{"prim":"key"}],"annots":["%signatories"]},{"prim":"nat","annots":["%group_threshold"]}]}],"annots":["%key_groups"]},{"prim":"nat","annots":["%overall_threshold"]}],"annots":["%Set_keys"]},{"prim":"option","args":[{"prim":"key_hash","annots":["%new_delegate"]}],"annots":["%Set_delegate"]}]}],"annots":["%action_input"]},{"prim":"list","args":[{"prim":"list","args":[{"prim":"option","args":[{"prim":"signature"}]}]}],"annots":["%signatures"]}],"annots":["%Action"]},{"prim":"option","args":[{"prim":"pair","args":[{"prim":"signature","annots":["%pour_auth"]},{"prim":"mumav","annots":["%pour_amount"]}],"annots":["%Pour"]}]}]}]}]`,
			want: `[{"name":"@or_1","type":"or","args":[{"key":"Action","value":"$Action"},{"key":"@option_28","value":"option($Pour)"}]},{"name":"Action","type":"pair","args":[{"key":"action_input","value":"$action_input"},{"key":"signatures","value":"list(list(option(signature)))"}]},{"name":"action_input","type":"or","args":[{"key":"Transfer","value":"$Transfer"},{"key":"Set_pour","value":"option($Set_pour)"},{"key":"Set_keys","value":"$Set_keys"},{"key":"Set_delegate","value":"option(key_hash)"}]},{"name":"Transfer","type":"pair","args":[{"key":"dest","value":"contract(unit)"},{"key":"transfer_amount","value":"mumav"}]},{"name":"Set_pour","type":"pair","args":[{"key":"pour_dest","value":"contract(unit)"},{"key":"pour_authorizer","value":"key"}]},{"name":"Set_keys","type":"pair","args":[{"key":"key_groups","value":"list($key_groups_item)"},{"key":"overall_threshold","value":"nat"}]},{"name":"key_groups_item","type":"pair","args":[{"key":"signatories","value":"list(key)"},{"key":"group_threshold","value":"nat"}]},{"name":"signatures_item","type":"list(option(signature))"},{"name":"Pour","type":"pair","args":[{"key":"pour_auth","value":"signature"},{"key":"pour_amount","value":"mumav"}]}]`,
		}, {
			...
			data: `[{"prim":"parameter","args":[{"prim":"or","args":[{"prim":"or","args":[{"prim":"list","args":[{"prim":"nat"}],"annots":["%setList"]},{"prim":"map","args":[{"prim":"nat"},{"prim":"mumav"}],"annots":["%setMap"]}]},{"prim":"set","args":[{"prim":"nat"}],"annots":["%setSet"]}]}]}]`,
			want: `[{"name":"@or_1","type":"or","args":[{"key":"setList","value":"list(nat)"},{"key":"setMap","value":"map(nat, mumav)"},{"key":"setSet","value":"set(nat)"}]}]`,
		}, {
...
func TestTypedAst_Compare(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			typ:  `[{"prim": "pair", "args":[{"prim": "int"}, {"prim": "option", "args":[{"prim": "address"}]}]}]`,
			a:    `{"prim": "Pair", "args":[{"int": "100"}, {"prim": "Some", "args":[{"string": "mv1ShyyCvhMT4SFy3JYzz41i9vBmWN4sfob7"}]}]}`,
...
func TestTypedAst_Settle(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			name:       "atomex",
			tree:       `[{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]},{"prim":"bytes","annots":[":hashed_secret","%add"]}],"annots":["%fund"]},{"prim":"or","args":[{"prim":"bytes","annots":[":secret","%redeem"]},{"prim":"bytes","annots":[":hashed_secret","%refund"]}],"annots":["%withdraw"]}]}]`,
			...
			data: `{"prim":"Pair","args":[{"string":"mv1CR3AWGxhWG4tGwdAk4JRmiJsP2RrmiD1J"},{"prim":"Pair","args":[{"int":"2038026"},{"string":"2021-02-09T18:22:14Z"}]}]}`,
			want: `{"prim":"Pair","args":[{"string":"mv1CR3AWGxhWG4tGwdAk4JRmiJsP2RrmiD1J"},{"prim":"Pair","args":[{"int":"2038026"},{"string":"2021-02-09T18:22:14Z"}]}]}`,
		}, {
			name: "setList",
			...
			name: "setMap",
			tree: `{"prim":"map","args":[{"prim":"nat"},{"prim":"mumav"}],"annots":["%setMap"]}`,
			data: `[{"prim":"Elt","args":[{"int":"2"},{"int":"2"}]}]`,
			want: `[{"prim":"Elt","args":[{"int":"2"},{"int":"2"}]}]`,
		}, {
			name: "setBigMap",
			tree: `{"prim":"big_map","args":[{"prim":"nat"},{"prim":"mumav"}],"annots":["%setMap"]}`,
			data: `[{"prim":"Elt","args":[{"int":"2"},{"int":"2"}]}]`,
			want: `[{"prim":"Elt","args":[{"int":"2"},{"int":"2"}]}]`,
		}, {
			name: "setSet",
...
func TestTypedAst_ToMiguel(t *testing.T) {
	tests := []struct {
		...
		{
			name: "atomex storage",
			tree: `{"prim":"pair","args":[{"prim":"big_map","args":[{"prim":"bytes"},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":["%initiator"]},{"prim":"address","annots":["%participant"]}],"annots":["%recipients"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"mumav","annots":["%amount"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}]}]},{"prim":"unit"}]}`,
			...
			tree: `{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]}`,
			data: `{"prim":"Pair","args":[{"string":"mv1CPJN7Y1DLG1huYoxZxBf77FYTG4u4d9xC"},{"prim":"Pair","args":[{"prim":"Pair","args":[{"bytes":"758af1ebc445c9561b6bf1f3de4c89c4b1b91c0ffc9d6b8325496734f09ef161"},{"int":"1612869027"}]},{"int":"0"}]}]}`,
			want: `[{"prim":"pair","type":"namedtuple","name":"initiate","children":[{"prim":"address","type":"address","name":"participant","value":"mv1CPJN7Y1DLG1huYoxZxBf77FYTG4u4d9xC"},{"prim":"pair","type":"namedtuple","name":"settings","children":[{"prim":"bytes","type":"bytes","name":"hashed_secret","value":"758af1ebc445c9561b6bf1f3de4c89c4b1b91c0ffc9d6b8325496734f09ef161"},{"prim":"timestamp","type":"timestamp","name":"refund_time","value":"2021-02-09T11:10:27Z"},{"prim":"mumav","type":"mumav","name":"payoff","value":"0"}]}]}]`,
		}, {
...
func TestTypedAst_Diff(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			prev: `{"args":[[{"args":[{"string":"1f4aa7e6f7ad11a90db94a3e2cb2060bcd7dc5db20b2d12b09c0fd92a15bbceb"},{"args":[{"args":[{"string":"mv1JDE9zTS2yDXvKnqY7W9UxFrfhu8Ya3Mn8"},{"string":"mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW"}],"prim":"Pair"},{"args":[{"args":[{"int":"200992827"},{"int":"1600334777"}],"prim":"Pair"},{"int":"0"}],"prim":"Pair"}],"prim":"Pair"}],"prim":"Elt"}],{"prim":"Unit"}],"prim":"Pair"}`,
			...
			tree: `{"prim":"pair","args":[{"prim":"big_map","args":[{"prim":"bytes"},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":["%initiator"]},{"prim":"address","annots":["%participant"]}],"annots":["%recipients"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"mumav","annots":["%amount"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}]}]},{"prim":"unit"}]}`,
			curr: `{"args":[[{"args":[{"string":"314d74100a3d994ae0b52114fb414d86001a0e4a1b122ef1d03ed5ad6b7c4f93"},{"args":[{"args":[{"string":"mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW"},{"string":"mv1AfeiEfJQiXomsJjDwtXEuc3TDu1sA3WQF"}],"prim":"Pair"},{"args":[{"args":[{"int":"192258291"},{"int":"1602590721"}],"prim":"Pair"},{"int":"0"}],"prim":"Pair"}],"prim":"Pair"}],"prim":"Elt"}],{"prim":"Unit"}],"prim":"Pair"}`,
			prev: `{"args":[{"int":"4"},{"prim":"Unit"}],"prim":"Pair"}`,
			want: `{"prim":"pair","type":"namedtuple","name":"@pair_1","children":[{"prim":"big_map","type":"big_map","name":"@big_map_2","children":[{"prim":"pair","type":"namedtuple","name":"314d74100a3d994ae0b52114fb414d86001a0e4a1b122ef1d03ed5ad6b7c4f93","diff_type":"create","children":[{"prim":"pair","type":"namedtuple","name":"recipients","diff_type":"create","children":[{"prim":"address","type":"address","name":"initiator","diff_type":"create","value":"mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW"},{"prim":"address","type":"address","name":"participant","diff_type":"create","value":"mv1AfeiEfJQiXomsJjDwtXEuc3TDu1sA3WQF"}]},{"prim":"pair","type":"namedtuple","name":"settings","diff_type":"create","children":[{"prim":"mumav","type":"mumav","name":"amount","diff_type":"create","value":"192258291"},{"prim":"timestamp","type":"timestamp","name":"refund_time","diff_type":"create","value":"2020-10-13T12:05:21Z"},{"prim":"mumav","type":"mumav","name":"payoff","diff_type":"create","value":"0"}]}]}]},{"prim":"unit","type":"unit","name":"@unit_13"}]}`,
		}, {
			name: "tzbtc transfer",
			...
			tree: `{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"list","args":[{"prim":"nat"}],"annots":["%list1"]},{"prim":"map","args":[{"prim":"nat"},{"prim":"mumav"}],"annots":["%map1"]}]},{"prim":"set","args":[{"prim":"nat"}],"annots":["%set1"]}]}`,
			...
			curr: `{"args":[{"args":[{"args":[{"args":[{"int":"1000"},{"int":"44121"}],"prim":"Pair"},{"args":[{"int":"44122"},[]],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"int":"44123"},{"prim":"False"}],"prim":"Pair"},{"args":[{"int":"11"},[{"args":[{"string":"mv1CH1X7V7YKx4o38DkgXFu5oePWPaSKZYzX"},{"args":[{"prim":"None"},[]],"prim":"Pair"}],"prim":"Elt"}]],"prim":"Pair"}],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"args":[{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"},{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"}],"prim":"Pair"},{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"},{"prim":"None"}],"prim":"Pair"}],"prim":"Pair"},{"int":"1000"}],"prim":"Pair"},{"prim":"None"}],"prim":"Pair"}],"prim":"Pair"}`,
			prev: `{"args":[{"args":[{"args":[{"args":[{"int":"1000"},{"int":"44121"}],"prim":"Pair"},{"args":[{"int":"44122"},[]],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"int":"44123"},{"prim":"False"}],"prim":"Pair"},{"args":[{"int":"11"},[{"args":[{"string":"mv1CH1X7V7YKx4o38DkgXFu5oePWPaSKZYzX"},{"args":[{"prim":"None"},[{"args":[{"string":"24b880dafed29ed33e79156e4aecc759927b73439afb91c25663333cc45758d1"},{"args":[{"int":"1610679129"},{"prim":"None"}],"prim":"Pair"}],"prim":"Elt"}]],"prim":"Pair"}],"prim":"Elt"}]],"prim":"Pair"}],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"args":[{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"},{"bytes":"0000f2037cc89912cc457e3d85cfe2bfc471b4b6022d"}],"prim":"Pair"},{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"},{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"}],"prim":"Some"}],"prim":"Pair"}],"prim":"Pair"},{"int":"1000"}],"prim":"Pair"},{"prim":"None"}],"prim":"Pair"}],"prim":"Pair"}`,
...
func TestTypedAst_ToBaseNode(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			name:      "atomex initiate",
			tree:      `{"prim":"pair","args":[{"prim":"big_map","args":[{"prim":"bytes"},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":["%initiator"]},{"prim":"address","annots":["%participant"]}],"annots":["%recipients"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"mumav","annots":["%amount"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}]}]},{"prim":"unit"}]}`,
			data:      `{"args":[[{"args":[{"string":"314d74100a3d994ae0b52114fb414d86001a0e4a1b122ef1d03ed5ad6b7c4f93"},{"args":[{"args":[{"string":"mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW"},{"string":"mv1AfeiEfJQiXomsJjDwtXEuc3TDu1sA3WQF"}],"prim":"Pair"},{"args":[{"args":[{"int":"192258291"},{"string":"2020-10-13T12:05:21Z"}],"prim":"Pair"},{"int":"0"}],"prim":"Pair"}],"prim":"Pair"}],"prim":"Elt"}],{"prim":"Unit"}],"prim":"Pair"}`,
			optimized: false,
		}, {
			name:      "edonet/KT1NeBYaiPiQH5jDWs3wJWzFynRsEGeUEUpZ/setList",
			tree:      `{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"list","args":[{"prim":"nat"}],"annots":["%list1"]},{"prim":"map","args":[{"prim":"nat"},{"prim":"mumav"}],"annots":["%map1"]}]},{"prim":"set","args":[{"prim":"nat"}],"annots":["%set1"]}]}`,
			...
			name:      "mainnet/KT1Puc9St8wdNoGtLiD2WXaHbWU7styaxYhD/addLiquidity",
			tree:      `{"prim":"pair","args":[{"prim":"big_map","args":[{"prim":"address","annots":[":owner"]},{"prim":"pair","args":[{"prim":"nat","annots":[":balance"]},{"prim":"map","args":[{"prim":"address","annots":[":spender"]},{"prim":"nat","annots":[":allowance"]}]}]}],"annots":["%accounts"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bool","annots":[":selfIsUpdatingTokenPool"]},{"prim":"pair","args":[{"prim":"bool","annots":[":freezeBaker"]},{"prim":"nat","annots":[":lqtTotal"]}]}]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":[":manager"]},{"prim":"address","annots":[":tokenAddress"]}]},{"prim":"pair","args":[{"prim":"nat","annots":[":tokenPool"]},{"prim":"mumav","annots":[":xtzPool"]}]}]}]}]}`,
			data:      `{"args":[[{"args":[{"string":"mv1HSjMEEn6MQL7jTCUp2ohoZqKFYYGYfexc"},{"args":[{"int":"4919489"},[]],"prim":"Pair"}],"prim":"Elt"}],{"args":[{"args":[{"prim":"False"},{"args":[{"prim":"False"},{"int":"55565098589"}],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"bytes":"011b5edfd90cc62eaf4299bdc2eedae4306bea9fe200"},{"bytes":"01813a19aa1cb96fe5b039c0bfc1633e61daf0ae3f00"}],"prim":"Pair"},{"args":[{"int":"169423316128"},{"int":"42961629151"}],"prim":"Pair"}],"prim":"Pair"}],"prim":"Pair"}],"prim":"Pair"}`,
			optimized: false,
		}, {
			name:      "delphinet/KT1NogASEVoWnYvbjRPbPuTK58Z3ttB8pRDC/accept_ownership",
			tree:      `{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"nat","annots":["%default_expiry"]},{"prim":"big_map","args":[{"prim":"address"},{"prim":"nat"}],"annots":["%ledger"]}]},{"prim":"pair","args":[{"prim":"big_map","args":[{"prim":"string"},{"prim":"bytes"}],"annots":["%metadata"]},{"prim":"map","args":[{"prim":"address"},{"prim":"nat"}],"annots":["%minting_allowances"]}]}]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"big_map","args":[{"prim":"pair","args":[{"prim":"address"},{"prim":"address"}]},{"prim":"unit"}],"annots":["%operators"]},{"prim":"bool","annots":["%paused"]}]},{"prim":"pair","args":[{"prim":"nat","annots":["%permit_counter"]},{"prim":"big_map","args":[{"prim":"address"},{"prim":"pair","args":[{"prim":"option","args":[{"prim":"nat"}],"annots":["%expiry"]},{"prim":"map","args":[{"prim":"bytes"},{"prim":"pair","args":[{"prim":"timestamp","annots":["%created_at"]},{"prim":"option","args":[{"prim":"nat"}],"annots":["%expiry"]}]}],"annots":["%permits"]}]}],"annots":["%permits"]}]}]}]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":["%master_minter"]},{"prim":"address","annots":["%owner"]}]},{"prim":"pair","args":[{"prim":"address","annots":["%pauser"]},{"prim":"option","args":[{"prim":"address"}],"annots":["%pending_owner"]}]}],"annots":["%roles"]},{"prim":"nat","annots":["%total_supply"]}]},{"prim":"option","args":[{"prim":"address"}],"annots":["%transferlist_contract"]}]}]}`,
			data:      `{"args":[{"args":[{"args":[{"args":[{"int":"1000"},{"int":"44121"}],"prim":"Pair"},{"args":[{"int":"44122"},[]],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"int":"44123"},{"prim":"False"}],"prim":"Pair"},{"args":[{"int":"11"},[{"args":[{"string":"mv1CH1X7V7YKx4o38DkgXFu5oePWPaSKZYzX"},{"args":[{"prim":"None"},[]],"prim":"Pair"}],"prim":"Elt"}]],"prim":"Pair"}],"prim":"Pair"}],"prim":"Pair"},{"args":[{"args":[{"args":[{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"},{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"}],"prim":"Pair"},{"args":[{"bytes":"00002ecf635a4b1508e6effe97aea69dcd99c1113dc0"},{"prim":"None"}],"prim":"Pair"}],"prim":"Pair"},{"int":"1000"}],"prim":"Pair"},{"prim":"None"}],"prim":"Pair"}],"prim":"Pair"}`,
			optimized: false,
		}, {
			name:      "edonet/KT1QHduqUZi4HRaFRaNAetWZmYTQprugQ2AS/default",
			tree:      `{"prim":"option","args":[{"prim":"bls12_381_fr"}]}`,
...
func TestTypedAst_FromJSONSchema(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "atomex initiate",
			tree: `{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]}`,
			data: `{"initiate":{"participant": "mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW", "settings":{"@pair_4":{"hashed_secret": "314d74100a3d994ae0b52114fb414d86001a0e4a1b122ef1d03ed5ad6b7c4f93", "refund_time": "2020-10-13T12:05:21Z"},"payoff": 800}}}`,
			want: `{"prim":"Pair","args":[{"string":"mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW"},{"prim":"Pair","args":[{"prim":"Pair","args":[{"bytes":"314d74100a3d994ae0b52114fb414d86001a0e4a1b122ef1d03ed5ad6b7c4f93"},{"int":"1602590721"}]},{"int":"800"}]}]}`,
		}, {
...
func TestTypedAst_FindByName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			tree:      `{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]},{"prim":"bytes","annots":[":hashed_secret","%add"]}],"annots":["%fund"]},{"prim":"or","args":[{"prim":"bytes","annots":[":secret","%redeem"]},{"prim":"bytes","annots":[":hashed_secret","%refund"]}],"annots":["%withdraw"]}]}`,
			fieldName: "initiate",
			want:      `{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]}`,
		}, {
			name:      "atomex/add",
			tree:      `{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]},{"prim":"bytes","annots":[":hashed_secret","%add"]}],"annots":["%fund"]},{"prim":"or","args":[{"prim":"bytes","annots":[":secret","%redeem"]},{"prim":"bytes","annots":[":hashed_secret","%refund"]}],"annots":["%withdraw"]}]}`,
			fieldName: "add",
			...
			tree:      `{"prim":"pair","args":[{"prim":"map","args":[{"prim":"bytes"},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":["%initiator"]},{"prim":"address","annots":["%participant"]}],"annots":["%recipients"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"mumav","annots":["%amount"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}]}]},{"prim":"unit"}]}`,
			fieldName: "unknown",
			want:      "null",
		}, {
			name:         "mainnet/KT1TnwBxgK4ayHuxrti6KKkJpWBHXBYRCX6H",
			tree:         `{"prim":"or","args":[{"prim":"or","args":[{"prim":"or","args":[{"prim":"unit","annots":["%deposit"]},{"prim":"mumav","annots":["%reRoll"]}]},{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":["%investor"]},{"prim":"address","annots":["%referrar"]}],"annots":["%register"]},{"prim":"or","args":[{"prim":"key_hash","annots":["%updateBaker"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"nat","annots":["%devFee"]},{"prim":"nat","annots":["%distributionPoolFee"]}]},{"prim":"pair","args":[{"prim":"nat","annots":["%referralFee"]},{"prim":"nat","annots":["%rewardPoolFee"]}]}],"annots":["%deposit"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"nat","annots":["%devFee"]},{"prim":"nat","annots":["%distributionPoolFee"]}]},{"prim":"pair","args":[{"prim":"nat","annots":["%referralFee"]},{"prim":"nat","annots":["%rewardPoolFee"]}]}],"annots":["%withdraw"]}],"annots":["%updateConfig"]}]}]}]},{"prim":"or","args":[{"prim":"or","args":[{"prim":"address","annots":["%updateInvestorBaker"]},{"prim":"address","annots":["%updateOwner"]}]},{"prim":"or","args":[{"prim":"int","annots":["%updateRewardPoolReleaseDayCount"]},{"prim":"or","args":[{"prim":"mumav","annots":["%withdraw"]},{"prim":"unit","annots":["%withdrawDevFee"]}]}]}]}]}`,
			fieldName:    "withdraw",
			isEntrypoint: true,
			want:         `{"prim":"mumav","annots":["%withdraw"]}`,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestTypedAst_FromParameters(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			tree:       `{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]},{"prim":"bytes","annots":[":hashed_secret","%add"]}],"annots":["%fund"]},{"prim":"or","args":[{"prim":"bytes","annots":[":secret","%redeem"]},{"prim":"bytes","annots":[":hashed_secret","%refund"]}],"annots":["%withdraw"]}]}`,
			entrypoint: "default",
			data:       `{"prim":"Left","args":[{"prim":"Left","args":[{"prim":"Pair","args":[{"string":"mv1QbjzQA9yJWzvZ81F5eHyqzcZpofRufsQW"},{"prim":"Pair","args":[{"prim":"Pair","args":[{"bytes":"182684bb81ef4008ed0acb6b7c40f3f3ddc08bda2ca11f4d2c31c43a8cff387e"},{"int":"1613402127"}]},{"int":"0"}]}]}]}]}`,
		}, {
			name:       "atomex/redeem",
			tree:       `{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":["%participant"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"bytes","annots":["%hashed_secret"]},{"prim":"timestamp","annots":["%refund_time"]}]},{"prim":"mumav","annots":["%payoff"]}],"annots":["%settings"]}],"annots":[":initiate","%initiate"]},{"prim":"bytes","annots":[":hashed_secret","%add"]}],"annots":["%fund"]},{"prim":"or","args":[{"prim":"bytes","annots":[":secret","%redeem"]},{"prim":"bytes","annots":[":hashed_secret","%refund"]}],"annots":["%withdraw"]}]}`,
			entrypoint: "default",
			...
			data:       `{"prim":"Pair","args":[{"string":"mv1KTWyQoj3oxBVQjrSv1j88AjwZa9MqCmQE"},{"prim":"Pair","args":[{"int":"2120690073714895"},{"int":"1613402584"}]}]}`,
		}, {
			name:       "dexter/tokenToXtz",
			tree:       `{"prim":"or","args":[{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":[":spender"]},{"prim":"pair","args":[{"prim":"nat","annots":[":allowance"]},{"prim":"nat","annots":[":currentAllowance"]}]}],"annots":["%approve"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":[":owner"]},{"prim":"nat","annots":[":minLqtMinted"]}]},{"prim":"pair","args":[{"prim":"nat","annots":[":maxTokensDeposited"]},{"prim":"timestamp","annots":[":deadline"]}]}],"annots":["%addLiquidity"]}]},{"prim":"or","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":[":owner"]},{"prim":"pair","args":[{"prim":"address","annots":[":to"]},{"prim":"nat","annots":[":lqtBurned"]}]}]},{"prim":"pair","args":[{"prim":"mumav","annots":[":minXtzWithdrawn"]},{"prim":"pair","args":[{"prim":"nat","annots":[":minTokensWithdrawn"]},{"prim":"timestamp","annots":[":deadline"]}]}]}],"annots":["%removeLiquidity"]},{"prim":"or","args":[{"prim":"pair","args":[{"prim":"address","annots":[":to"]},{"prim":"pair","args":[{"prim":"nat","annots":[":minTokensBought"]},{"prim":"timestamp","annots":[":deadline"]}]}],"annots":["%xtzToToken"]},{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":[":owner"]},{"prim":"address","annots":[":to"]}]},{"prim":"pair","args":[{"prim":"nat","annots":[":tokensSold"]},{"prim":"pair","args":[{"prim":"mumav","annots":[":minXtzBought"]},{"prim":"timestamp","annots":[":deadline"]}]}]}],"annots":["%tokenToXtz"]}]}]}]},{"prim":"or","args":[{"prim":"or","args":[{"prim":"pair","args":[{"prim":"pair","args":[{"prim":"address","annots":[":outputDexterContract"]},{"prim":"pair","args":[{"prim":"nat","annots":[":minTokensBought"]},{"prim":"address","annots":[":owner"]}]}]},{"prim":"pair","args":[{"prim":"address","annots":[":to"]},{"prim":"pair","args":[{"prim":"nat","annots":[":tokensSold"]},{"prim":"timestamp","annots":[":deadline"]}]}]}],"annots":["%tokenToToken"]},{"prim":"or","args":[{"prim":"key_hash","annots":["%updateTokenPool"]},{"prim":"nat","annots":["%updateTokenPoolInternal"]}]}]},{"prim":"or","args":[{"prim":"pair","args":[{"prim":"option","args":[{"prim":"key_hash"}]},{"prim":"bool"}],"annots":["%setBaker"]},{"prim":"or","args":[{"prim":"address","annots":["%setManager"]},{"prim":"unit","annots":["%default"]}]}]}]}]}`,
			entrypoint: "tokenToXtz",
			data:       `{"prim":"Pair","args":[{"prim":"Pair","args":[{"string":"mv1WHsVnE6B9Ek6q4VX4c8288HAT4N9o1MX8"},{"string":"mv1WHsVnE6B9Ek6q4VX4c8288HAT4N9o1MX8"}]},{"prim":"Pair","args":[{"int":"100000000000000000"},{"prim":"Pair","args":[{"int":"33682887"},{"int":"1613393537"}]}]}]}`,
		}, {
			name:       "aspen/transfer",
			...
			entrypoint: "default",
			data:       `{"prim":"Right","args":[{"prim":"Left","args":[{"prim":"Right","args":[{"prim":"Right","args":[{"prim":"Pair","args":[{"string":"mv1UqPbHS2Z4TeQZGdLvGR3Ldba9zGY7X4Yv"},{"prim":"Pair","args":[{"string":"mv1FKB4fP4TnkV3whM1DLi9Xbw7fvtmgseLf"},{"int":"1100000"}]}]}]}]}]}]}`,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestTypedAst_ParametersForExecution(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			entrypoint: "offer",
			data:       `{"@pair_45":{"currency":{"schemaKey":"RR"},"@pair_53":{"@pair_55":{"@pair_60":{"expiry_time":{"schemaKey":"None"},"@pair_63":{"proxy":{"schemaKey":"None"},"target":{"schemaKey":"None"}}},"shares":[{"@pair_57":{"amount":"1000","recipient":"mv2XhKc3pCg6sicrriH8NrGD1jvbUbmwJwuf"}}]},"amount":"1000"}},"token":{"token_id":{"schemaKey":"None"},"address":"KT1RJ6PbjHpwc3M5rw5s2Nbmefwbuwbdxton"}}`,
		}, {
			name:       "test 2",
