...
import (
	...
	modelContract "github.com/mavryk-network/bcdhub/internal/models/contract"
	"github.com/mavryk-network/bcdhub/internal/models/migration"
	mock_general "github.com/mavryk-network/bcdhub/internal/models/mock"
	mock_accounts "github.com/mavryk-network/bcdhub/internal/models/mock/account"
	mock_bmd "github.com/mavryk-network/bcdhub/internal/models/mock/bigmapdiff"
	mock_block "github.com/mavryk-network/bcdhub/internal/models/mock/block"
	mock_contract "github.com/mavryk-network/bcdhub/internal/models/mock/contract"
	mock_operations "github.com/mavryk-network/bcdhub/internal/models/mock/operation"
	mock_proto "github.com/mavryk-network/bcdhub/internal/models/mock/protocol"
				...
				Operations: []*operation.Operation{
					{
						...
						Source: account.Account{
							Address:         "mv1WeVvv9HmMd5oFPfsdshv6SHjaKpBfLo5X",
						...
						ProtocolID:      1,
						Parameters:      []byte("{\"entrypoint\":\"default\",\"value\":{\"prim\":\"Right\",\"args\":[{\"prim\":\"Left\",\"args\":[{\"prim\":\"Right\",\"args\":[{\"prim\":\"Right\",\"args\":[{\"prim\":\"Pair\",\"args\":[{\"string\":\"mv1WeVvv9HmMd5oFPfsdshv6SHjaKpBfLo5X\"},{\"prim\":\"Pair\",\"args\":[{\"string\":\"tz1invbJv3AEm55ct7QF2dVbWZuaDekssYkV\"},{\"int\":\"8010000\"}]}]}]}]}]}]}}"),
				...
				Operations: []*operation.Operation{
					{
						...
						Initiator: account.Account{
							Address:         "mv1Sf1tuc47WzgABGpaaJBMfctpGerb7y1T8",
							Type:            types.AccountTypeTz,
							Level:           86142,
							OperationsCount: 1,
							LastAction:      timestamp,
				...
				Operations: []*operation.Operation{
					{
						Kind: types.OperationKindOrigination,
						Source: account.Account{
							Address:         "mv1N1478quc6RWj1rHbdBLSKs7Nv2Y2vPyth",
							Type:            types.AccountTypeTz,
							Level:           301436,
							OperationsCount: 1,
							LastAction:      timestamp,
				...
				Operations: []*operation.Operation{
					{
						Kind: types.OperationKindTransaction,
						Source: account.Account{
							Address:         "mv1DWx8WTi9swgP4qC7NH8Kz8a18JGMgJD8F",
							Type:            types.AccountTypeTz,
							Level:           72207,
							OperationsCount: 1,
							LastAction:      timestamp,
				...
				Operations: []*operation.Operation{
					{
						Kind: types.OperationKindTransaction,
						Source: account.Account{
							Address:         "mv1Su2woDETo93dQUePV1v53NBFouWUiojyS",
							Type:            types.AccountTypeTz,
							Level:           1516349,
							OperationsCount: 1,
							LastAction:      timestamp,
						...
						Delegate:        account.Account{},
						Parameters:      []byte(`{"entrypoint":"transfer","value":[{"prim":"Pair","args":[{"string":"mv1Su2woDETo93dQUePV1v53NBFouWUiojyS"},[{"prim":"Pair","args":[{"string":"tz1a6ZKyEoCmfpsY74jEq6uKBK8RQXdj1aVi"},{"prim":"Pair","args":[{"int":"12"},{"int":"1"}]}]}]]}]}`),
						ProtocolID:      4,
				...
				Operations: []*operation.Operation{
					{
						...
						Source: account.Account{
							Address:         "mv1NSEvqRxRGV3xBpZp4uFteHxVXMBJAFEwR",
							Type:            types.AccountTypeTz,
							Level:           15400,
							OperationsCount: 1,
							LastAction:      timestamp,
				...
				Operations: []*operation.Operation{
					{
						...
						Source: account.Account{
							Address:         "mv1UHYw7Qb48hss5SRspBQpp4NjX1YKQTBZy",
							Type:            types.AccountTypeTz,
							Level:           381735,
							OperationsCount: 1,
							LastAction:      timestamp,
						...
						Level:               381735,
						ProtocolID:          6,
						Parameters:          []byte(`{"entrypoint":"add_pool","value":{"prim":"Pair","args":[{"int":"100000"},{"prim":"Pair","args":[[{"prim":"Left","args":[{"string":"KT1CR5crmVrJntzwv5XVrBv8Dk1mxZFKHj9z"}]},{"prim":"Right","args":[{"prim":"Pair","args":[{"string":"KT19H9YbHqsxFTayap7aTEfbcnyPeALKYgt9"},{"int":"0"}]}]}],{"prim":"Pair","args":[[{"prim":"Elt","args":[{"int":"0"},{"prim":"Pair","args":[{"int":"1000000000000000000"},{"int":"1000000000000000000000000"}]}]},{"prim":"Elt","args":[{"int":"1"},{"prim":"Pair","args":[{"int":"1000000000000000000"},{"int":"100000000000000000000000000"}]}]}],{"prim":"Pair","args":[{"string":"mv1UHYw7Qb48hss5SRspBQpp4NjX1YKQTBZy"},[{"string":"mv1UHYw7Qb48hss5SRspBQpp4NjX1YKQTBZy"}]]}]}]}]}}`),
				...
				Operations: []*operation.Operation{
					{
						Kind: types.OperationKindOrigination,
						Source: account.Account{
							Address:         "mv1JXfmf9bMV92RGGzgWuzF9EqCJZ2JZJBiP",
							Type:            types.AccountTypeTz,
							Level:           707452,
							OperationsCount: 1,
							LastAction:      timestamp,
						...
						Delegate:        account.Account{},
						ProtocolID:      6,
						DeffatedStorage: []byte(`[[{"string":"mv1JXfmf9bMV92RGGzgWuzF9EqCJZ2JZJBiP"},{"prim":"None"}],{"string":"KT1LnwXLwrH3ejammJ1CJFgezpsehXFDNREU"}]`),
					},
				},
				Contracts: []*modelContract.Contract{
					{
				...
				Operations: []*operation.Operation{
					{
						...
						Source: account.Account{
							Address:         "mv1BwsDbTFGH1vVjzNAwUGCV6usU19sCmEK2",
							Type:            types.AccountTypeTz,
							Level:           1616868,
							OperationsCount: 1,
							LastAction:      timestamp,
