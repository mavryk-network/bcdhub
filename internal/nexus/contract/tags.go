...
import (
	...
	"github.com/mavryk-network/nexushub/internal/nexus/contract/trees"
	"github.com/mavryk-network/nexushub/internal/nexus/forge"
)
...
func checkStorageIsDelegator(storage ast.UntypedAST) bool {
	...
	case storage[0].StringValue != nil:
		return nexus.IsAddress(*storage[0].StringValue)
